/**
 * INVENTORY_Enterprise_DomainService_13 - Enterprise Domain Engine
...
class INVENTORY_Enterprise_DomainService_13 {
  constructor(repository, eventBus, options = {}) {
    this.serviceName = 'INVENTORY_Enterprise_DomainService_13';
    this.domain = 'inventory';
    this.repository = repository;
    this.eventBus = eventBus;
    this.options = options;
    this.logger = new Logger('inventory-inventory_enterprise_domainservice_13');
...
module.exports = { INVENTORY_Enterprise_DomainService_13 };
