/**
 * INVENTORY_Enterprise_DomainService_3 - Enterprise Domain Engine
...
class INVENTORY_Enterprise_DomainService_3 {
  constructor(repository, eventBus, options = {}) {
    this.serviceName = 'INVENTORY_Enterprise_DomainService_3';
    this.domain = 'inventory';
    this.repository = repository;
    this.eventBus = eventBus;
    this.options = options;
    this.logger = new Logger('inventory-inventory_enterprise_domainservice_3');
...
module.exports = { INVENTORY_Enterprise_DomainService_3 };
