/**
 * INVENTORY_Enterprise_DomainService_18 - Enterprise Domain Engine
...
class INVENTORY_Enterprise_DomainService_18 {
  constructor(repository, eventBus, options = {}) {
    this.serviceName = 'INVENTORY_Enterprise_DomainService_18';
    this.domain = 'inventory';
    this.repository = repository;
    this.eventBus = eventBus;
    this.options = options;
    this.logger = new Logger('inventory-inventory_enterprise_domainservice_18');
...
module.exports = { INVENTORY_Enterprise_DomainService_18 };
