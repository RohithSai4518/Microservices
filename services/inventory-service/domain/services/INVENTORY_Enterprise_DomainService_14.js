/**
 * INVENTORY_Enterprise_DomainService_14 - Enterprise Domain Engine
...
class INVENTORY_Enterprise_DomainService_14 {
  constructor(repository, eventBus, options = {}) {
    this.serviceName = 'INVENTORY_Enterprise_DomainService_14';
    this.domain = 'inventory';
    this.repository = repository;
    this.eventBus = eventBus;
    this.options = options;
    this.logger = new Logger('inventory-inventory_enterprise_domainservice_14');
...
module.exports = { INVENTORY_Enterprise_DomainService_14 };
