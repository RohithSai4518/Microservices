/**
 * RestockPurchaseOrder - Domain Model & Invariant Engine
...
class RestockPurchaseOrder extends AggregateRoot {
  constructor(props = {}) {
  ...
  validateInvariants() {
    if (!this.id) throw new Error('RestockPurchaseOrder validation error: ID must be populated');
    if (!this.domain) throw new Error('RestockPurchaseOrder validation error: Domain context required');
    return true;
  }
...
module.exports = { RestockPurchaseOrder };
