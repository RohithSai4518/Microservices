/**
 * StockMovementAudit - Domain Model & Invariant Engine
...
class StockMovementAudit extends AggregateRoot {
  constructor(props = {}) {
  ...
  validateInvariants() {
    if (!this.id) throw new Error('StockMovementAudit validation error: ID must be populated');
    if (!this.domain) throw new Error('StockMovementAudit validation error: Domain context required');
    return true;
  }
...
module.exports = { StockMovementAudit };
