/**
 * StockTransferRequest - Domain Model & Invariant Engine
...
class StockTransferRequest extends AggregateRoot {
  constructor(props = {}) {
  ...
  validateInvariants() {
    if (!this.id) throw new Error('StockTransferRequest validation error: ID must be populated');
    if (!this.domain) throw new Error('StockTransferRequest validation error: Domain context required');
    return true;
  }
...
module.exports = { StockTransferRequest };
