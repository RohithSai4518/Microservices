/**
 * BinLocationMap - Domain Model & Invariant Engine
...
class BinLocationMap extends AggregateRoot {
  constructor(props = {}) {
  ...
  validateInvariants() {
    if (!this.id) throw new Error('BinLocationMap validation error: ID must be populated');
    if (!this.domain) throw new Error('BinLocationMap validation error: Domain context required');
    return true;
  }
