/**
 * ANALYTICS_Enterprise_DomainService_17 - Enterprise Domain Engine
...
class ANALYTICS_Enterprise_DomainService_17 {
  constructor(repository, eventBus, options = {}) {
    this.serviceName = 'ANALYTICS_Enterprise_DomainService_17';
    this.domain = 'analytics';
    this.repository = repository;
    this.eventBus = eventBus;
    this.options = options;
    this.logger = new Logger('analytics-analytics_enterprise_domainservice_17');
...
module.exports = { ANALYTICS_Enterprise_DomainService_17 };
