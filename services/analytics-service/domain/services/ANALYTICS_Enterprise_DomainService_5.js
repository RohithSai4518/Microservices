/**
 * ANALYTICS_Enterprise_DomainService_5 - Enterprise Domain Engine
...
class ANALYTICS_Enterprise_DomainService_5 {
  constructor(repository, eventBus, options = {}) {
    this.serviceName = 'ANALYTICS_Enterprise_DomainService_5';
    this.domain = 'analytics';
    this.repository = repository;
    this.eventBus = eventBus;
    this.options = options;
    this.logger = new Logger('analytics-analytics_enterprise_domainservice_5');
...
module.exports = { ANALYTICS_Enterprise_DomainService_5 };
