/**
 * ANALYTICS_Enterprise_DomainService_1 - Enterprise Domain Engine
...
class ANALYTICS_Enterprise_DomainService_1 {
  constructor(repository, eventBus, options = {}) {
    this.serviceName = 'ANALYTICS_Enterprise_DomainService_1';
    this.domain = 'analytics';
    this.repository = repository;
    this.eventBus = eventBus;
    this.options = options;
    this.logger = new Logger('analytics-analytics_enterprise_domainservice_1');
...
module.exports = { ANALYTICS_Enterprise_DomainService_1 };
