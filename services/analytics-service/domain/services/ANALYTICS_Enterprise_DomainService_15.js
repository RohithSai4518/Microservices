/**
 * ANALYTICS_Enterprise_DomainService_15 - Enterprise Domain Engine
...
class ANALYTICS_Enterprise_DomainService_15 {
  constructor(repository, eventBus, options = {}) {
    this.serviceName = 'ANALYTICS_Enterprise_DomainService_15';
    this.domain = 'analytics';
    this.repository = repository;
    this.eventBus = eventBus;
    this.options = options;
    this.logger = new Logger('analytics-analytics_enterprise_domainservice_15');
...
module.exports = { ANALYTICS_Enterprise_DomainService_15 };
