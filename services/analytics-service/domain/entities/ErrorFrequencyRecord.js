/**
 * ErrorFrequencyRecord - Domain Model & Invariant Engine
...
class ErrorFrequencyRecord extends AggregateRoot {
  constructor(props = {}) {
  ...
  validateInvariants() {
    if (!this.id) throw new Error('ErrorFrequencyRecord validation error: ID must be populated');
    if (!this.domain) throw new Error('ErrorFrequencyRecord validation error: Domain context required');
    return true;
  }
...
module.exports = { ErrorFrequencyRecord };
