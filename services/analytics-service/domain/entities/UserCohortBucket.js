/**
 * UserCohortBucket - Domain Model & Invariant Engine
...
class UserCohortBucket extends AggregateRoot {
  constructor(props = {}) {
  ...
  validateInvariants() {
    if (!this.id) throw new Error('UserCohortBucket validation error: ID must be populated');
    if (!this.domain) throw new Error('UserCohortBucket validation error: Domain context required');
    return true;
  }
...
module.exports = { UserCohortBucket };
