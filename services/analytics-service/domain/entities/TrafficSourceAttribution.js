/**
 * TrafficSourceAttribution - Domain Model & Invariant Engine
...
class TrafficSourceAttribution extends AggregateRoot {
  constructor(props = {}) {
  ...
  validateInvariants() {
    if (!this.id) throw new Error('TrafficSourceAttribution validation error: ID must be populated');
    if (!this.domain) throw new Error('TrafficSourceAttribution validation error: Domain context required');
    return true;
  }
...
module.exports = { TrafficSourceAttribution };
