/**
 * ConversionFunnelStep - Domain Model & Invariant Engine
...
class ConversionFunnelStep extends AggregateRoot {
  constructor(props = {}) {
  ...
  validateInvariants() {
    if (!this.id) throw new Error('ConversionFunnelStep validation error: ID must be populated');
    if (!this.domain) throw new Error('ConversionFunnelStep validation error: Domain context required');
    return true;
  }
...
module.exports = { ConversionFunnelStep };
