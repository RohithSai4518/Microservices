/**
 * SalesSummarySnapshot - Domain Model & Invariant Engine
...
class SalesSummarySnapshot extends AggregateRoot {
  constructor(props = {}) {
  ...
  validateInvariants() {
    if (!this.id) throw new Error('SalesSummarySnapshot validation error: ID must be populated');
    if (!this.domain) throw new Error('SalesSummarySnapshot validation error: Domain context required');
    return true;
  }
...
module.exports = { SalesSummarySnapshot };
