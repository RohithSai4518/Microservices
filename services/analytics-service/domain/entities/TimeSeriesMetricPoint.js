/**
 * TimeSeriesMetricPoint - Domain Model & Invariant Engine
...
class TimeSeriesMetricPoint extends AggregateRoot {
  constructor(props = {}) {
  ...
  validateInvariants() {
    if (!this.id) throw new Error('TimeSeriesMetricPoint validation error: ID must be populated');
    if (!this.domain) throw new Error('TimeSeriesMetricPoint validation error: Domain context required');
    return true;
  }
...
module.exports = { TimeSeriesMetricPoint };
