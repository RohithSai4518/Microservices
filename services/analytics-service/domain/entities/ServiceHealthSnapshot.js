/**
 * ServiceHealthSnapshot - Domain Model & Invariant Engine
...
class ServiceHealthSnapshot extends AggregateRoot {
  constructor(props = {}) {
  ...
  validateInvariants() {
    if (!this.id) throw new Error('ServiceHealthSnapshot validation error: ID must be populated');
    if (!this.domain) throw new Error('ServiceHealthSnapshot validation error: Domain context required');
    return true;
  }
...
module.exports = { ServiceHealthSnapshot };
