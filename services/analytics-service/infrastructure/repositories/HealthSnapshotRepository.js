/**
 * HealthSnapshotRepository - Data Access Repository Layer
...
class HealthSnapshotRepository {
  constructor(options = {}) {
    this.store = new DocumentStore('analytics_healthsnapshots', options);
  }
...
module.exports = { HealthSnapshotRepository };
