/**
 * UserKYCProfile - Domain Model & Invariant Engine
...
class UserKYCProfile extends AggregateRoot {
  constructor(props = {}) {
  ...
  validateInvariants() {
    if (!this.id) throw new Error('UserKYCProfile validation error: ID must be populated');
    if (!this.domain) throw new Error('UserKYCProfile validation error: Domain context required');
    return true;
  }
