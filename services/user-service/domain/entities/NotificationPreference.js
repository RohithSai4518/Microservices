/**
 * NotificationPreference - Domain Model & Invariant Engine
...
class NotificationPreference extends AggregateRoot {
  ...
  validateInvariants() {
    if (!this.id) throw new Error('NotificationPreference validation error: ID must be populated');
    if (!this.domain) throw new Error('NotificationPreference validation error: Domain context required');
    return true;
  }
