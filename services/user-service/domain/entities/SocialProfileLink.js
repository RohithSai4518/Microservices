/**
 * SocialProfileLink - Domain Model & Invariant Engine
...
class SocialProfileLink extends AggregateRoot {
  constructor(props = {}) {
  ...
  validateInvariants() {
    if (!this.id) throw new Error('SocialProfileLink validation error: ID must be populated');
    if (!this.domain) throw new Error('SocialProfileLink validation error: Domain context required');
    return true;
  }
...
module.exports = { SocialProfileLink };
