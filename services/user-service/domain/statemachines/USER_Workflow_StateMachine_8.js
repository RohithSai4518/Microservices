...
class USER_Workflow_StateMachine_8 {
  ...
  transition(targetState, context = {}) {
    if (!this.canTransitionTo(targetState)) {
      throw new Error(`Illegal State Transition: Cannot move from '${this.currentState}' to '${targetState}' in USER_Workflow_StateMachine_8`);
    }
...
module.exports = { USER_Workflow_StateMachine_8 };
