/**
 * USER_Enterprise_DomainService_16 - Enterprise Domain Engine
...
class USER_Enterprise_DomainService_16 {
  constructor(repository, eventBus, options = {}) {
    this.serviceName = 'USER_Enterprise_DomainService_16';
    this.domain = 'user';
    this.repository = repository;
    this.eventBus = eventBus;
    this.options = options;
    this.logger = new Logger('user-user_enterprise_domainservice_16');
...
module.exports = { USER_Enterprise_DomainService_16 };
