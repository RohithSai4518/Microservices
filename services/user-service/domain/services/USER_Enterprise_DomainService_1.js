/**
 * USER_Enterprise_DomainService_1 - Enterprise Domain Engine
...
class USER_Enterprise_DomainService_1 {
  constructor(repository, eventBus, options = {}) {
    this.serviceName = 'USER_Enterprise_DomainService_1';
    this.domain = 'user';
    this.repository = repository;
    this.eventBus = eventBus;
    this.options = options;
    this.logger = new Logger('user-user_enterprise_domainservice_1');
...
module.exports = { USER_Enterprise_DomainService_1 };
