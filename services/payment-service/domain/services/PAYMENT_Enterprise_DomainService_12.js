/**
 * PAYMENT_Enterprise_DomainService_12 - Enterprise Domain Engine
...
class PAYMENT_Enterprise_DomainService_12 {
  constructor(repository, eventBus, options = {}) {
    this.serviceName = 'PAYMENT_Enterprise_DomainService_12';
    this.domain = 'payment';
    this.repository = repository;
    this.eventBus = eventBus;
    this.options = options;
    this.logger = new Logger('payment-payment_enterprise_domainservice_12');
...
module.exports = { PAYMENT_Enterprise_DomainService_12 };
