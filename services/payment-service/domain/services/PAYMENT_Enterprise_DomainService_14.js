/**
 * PAYMENT_Enterprise_DomainService_14 - Enterprise Domain Engine
...
class PAYMENT_Enterprise_DomainService_14 {
  constructor(repository, eventBus, options = {}) {
    this.serviceName = 'PAYMENT_Enterprise_DomainService_14';
    this.domain = 'payment';
    this.repository = repository;
    this.eventBus = eventBus;
    this.options = options;
    this.logger = new Logger('payment-payment_enterprise_domainservice_14');
...
module.exports = { PAYMENT_Enterprise_DomainService_14 };
