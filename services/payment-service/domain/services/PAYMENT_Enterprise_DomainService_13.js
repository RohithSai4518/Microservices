/**
 * PAYMENT_Enterprise_DomainService_13 - Enterprise Domain Engine
...
class PAYMENT_Enterprise_DomainService_13 {
  constructor(repository, eventBus, options = {}) {
    this.serviceName = 'PAYMENT_Enterprise_DomainService_13';
    this.domain = 'payment';
    this.repository = repository;
    this.eventBus = eventBus;
    this.options = options;
    this.logger = new Logger('payment-payment_enterprise_domainservice_13');
...
module.exports = { PAYMENT_Enterprise_DomainService_13 };
