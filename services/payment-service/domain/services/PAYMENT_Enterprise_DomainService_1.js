/**
 * PAYMENT_Enterprise_DomainService_1 - Enterprise Domain Engine
...
class PAYMENT_Enterprise_DomainService_1 {
  constructor(repository, eventBus, options = {}) {
    this.serviceName = 'PAYMENT_Enterprise_DomainService_1';
    this.domain = 'payment';
    this.repository = repository;
    this.eventBus = eventBus;
    this.options = options;
    this.logger = new Logger('payment-payment_enterprise_domainservice_1');
...
module.exports = { PAYMENT_Enterprise_DomainService_1 };
