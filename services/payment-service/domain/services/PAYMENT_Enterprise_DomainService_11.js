/**
 * PAYMENT_Enterprise_DomainService_11 - Enterprise Domain Engine
...
class PAYMENT_Enterprise_DomainService_11 {
  constructor(repository, eventBus, options = {}) {
    this.serviceName = 'PAYMENT_Enterprise_DomainService_11';
    this.domain = 'payment';
    this.repository = repository;
    this.eventBus = eventBus;
    this.options = options;
    this.logger = new Logger('payment-payment_enterprise_domainservice_11');
...
module.exports = { PAYMENT_Enterprise_DomainService_11 };
