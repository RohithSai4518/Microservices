/**
 * IdempotencyKeyRecord - Domain Model & Invariant Engine
...
class IdempotencyKeyRecord extends AggregateRoot {
  constructor(props = {}) {
  ...
  validateInvariants() {
    if (!this.id) throw new Error('IdempotencyKeyRecord validation error: ID must be populated');
    if (!this.domain) throw new Error('IdempotencyKeyRecord validation error: Domain context required');
    return true;
  }
...
module.exports = { IdempotencyKeyRecord };
