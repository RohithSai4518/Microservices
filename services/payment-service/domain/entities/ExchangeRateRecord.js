/**
 * ExchangeRateRecord - Domain Model & Invariant Engine
...
class ExchangeRateRecord extends AggregateRoot {
  constructor(props = {}) {
  ...
  validateInvariants() {
    if (!this.id) throw new Error('ExchangeRateRecord validation error: ID must be populated');
    if (!this.domain) throw new Error('ExchangeRateRecord validation error: Domain context required');
    return true;
  }
...
module.exports = { ExchangeRateRecord };
