...
class ORDER_Workflow_StateMachine_6 {
  ...
  transition(targetState, context = {}) {
    if (!this.canTransitionTo(targetState)) {
      throw new Error(`Illegal State Transition: Cannot move from '${this.currentState}' to '${targetState}' in ORDER_Workflow_StateMachine_6`);
    }
...
module.exports = { ORDER_Workflow_StateMachine_6 };
