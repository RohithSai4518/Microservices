/**
 * ShippingAllocation - Domain Model & Invariant Engine
...
class ShippingAllocation extends AggregateRoot {
  constructor(props = {}) {
  ...
  validateInvariants() {
    if (!this.id) throw new Error('ShippingAllocation validation error: ID must be populated');
    if (!this.domain) throw new Error('ShippingAllocation validation error: Domain context required');
    return true;
  }
...
module.exports = { ShippingAllocation };
