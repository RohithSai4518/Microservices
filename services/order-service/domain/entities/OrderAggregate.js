/**
 * OrderAggregate - Domain Model & Invariant Engine
...
class OrderAggregate extends AggregateRoot {
  ...
  validateInvariants() {
    if (!this.id) throw new Error('OrderAggregate validation error: ID must be populated');
    if (!this.domain) throw new Error('OrderAggregate validation error: Domain context required');
    return true;
  }
