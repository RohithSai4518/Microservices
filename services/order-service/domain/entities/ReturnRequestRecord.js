/**
 * ReturnRequestRecord - Domain Model & Invariant Engine
...
class ReturnRequestRecord extends AggregateRoot {
  constructor(props = {}) {
  ...
  validateInvariants() {
    if (!this.id) throw new Error('ReturnRequestRecord validation error: ID must be populated');
    if (!this.domain) throw new Error('ReturnRequestRecord validation error: Domain context required');
    return true;
  }
...
module.exports = { ReturnRequestRecord };
