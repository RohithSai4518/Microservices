/**
 * FulfillmentTracking - Domain Model & Invariant Engine
...
class FulfillmentTracking extends AggregateRoot {
  constructor(props = {}) {
  ...
  validateInvariants() {
    if (!this.id) throw new Error('FulfillmentTracking validation error: ID must be populated');
    if (!this.domain) throw new Error('FulfillmentTracking validation error: Domain context required');
    return true;
  }
...
module.exports = { FulfillmentTracking };
