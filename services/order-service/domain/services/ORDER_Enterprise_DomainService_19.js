/**
 * ORDER_Enterprise_DomainService_19 - Enterprise Domain Engine
...
class ORDER_Enterprise_DomainService_19 {
  constructor(repository, eventBus, options = {}) {
    this.serviceName = 'ORDER_Enterprise_DomainService_19';
    this.domain = 'order';
    this.repository = repository;
    this.eventBus = eventBus;
    this.options = options;
    this.logger = new Logger('order-order_enterprise_domainservice_19');
...
module.exports = { ORDER_Enterprise_DomainService_19 };
