/**
 * CancellationAllowedRule - Business Rule Specification
 * Evaluates domain state invariants against enterprise policies.
 */
class CancellationAllowedRule {
  constructor(parameters = {}) {
    this.parameters = parameters;
    this.ruleName = 'CancellationAllowedRule';
  }
...
module.exports = { CancellationAllowedRule };
