/**
 * InvoiceRefRepository - Data Access Repository Layer
 * Interacts with ACID Document Store with indexing, sorting, and pagination.
 */
const { DocumentStore } = require('../../../../shared/storage');

class InvoiceRefRepository {
  constructor(options = {}) {
    this.store = new DocumentStore('order_invoicerefs', options);
  }
...
module.exports = { InvoiceRefRepository };
