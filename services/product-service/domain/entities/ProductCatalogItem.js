/**
 * ProductCatalogItem - Domain Model & Invariant Engine
...
class ProductCatalogItem extends AggregateRoot {
  constructor(props = {}) {
  ...
  validateInvariants() {
    if (!this.id) throw new Error('ProductCatalogItem validation error: ID must be populated');
    if (!this.domain) throw new Error('ProductCatalogItem validation error: Domain context required');
    return true;
  }
...
module.exports = { ProductCatalogItem };
