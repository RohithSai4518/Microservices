/**
 * PRODUCT_Enterprise_DomainService_8 - Enterprise Domain Engine
...
class PRODUCT_Enterprise_DomainService_8 {
  constructor(repository, eventBus, options = {}) {
    this.serviceName = 'PRODUCT_Enterprise_DomainService_8';
    this.domain = 'product';
    this.repository = repository;
    this.eventBus = eventBus;
    this.options = options;
    this.logger = new Logger('product-product_enterprise_domainservice_8');
...
module.exports = { PRODUCT_Enterprise_DomainService_8 };
