/**
 * NotificationTelemetryService - Application Service
...
class NotificationTelemetryService {
  constructor(repository, eventBus, options = {}) {
    ...
    this.logger = new Logger('notification-notificationtelemetryservice');
  ...
  async execute(command, context = {}) {
    ...
    this.logger.info('Executing operation in NotificationTelemetryService', { traceId, commandName: command ? command.constructor.name : 'DirectCall' });
    ...
    try {
      ...
      const computationResult = {
        ...
        service: 'NotificationTelemetryService',
        status: 'PROCESSED',
      ...
      if (this.eventBus) {
        await this.eventBus.publish('notification.notificationtelemetryservice.executed', {
      ...
      this.logger.error('Error executing NotificationTelemetryService: ' + err.message, { traceId });
...
module.exports = { NotificationTelemetryService };
