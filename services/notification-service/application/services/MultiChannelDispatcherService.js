/**
 * MultiChannelDispatcherService - Application Service
...
class MultiChannelDispatcherService {
  constructor(repository, eventBus, options = {}) {
    this.repository = repository;
    this.eventBus = eventBus;
    this.options = options;
    this.logger = new Logger('notification-multichanneldispatcherservice');
  ...
  async execute(command, context = {}) {
    ...
    this.logger.info('Executing operation in MultiChannelDispatcherService', { traceId, commandName: command ? command.constructor.name : 'DirectCall' });
    ...
    try {
      ...
      const computationResult = {
        ...
        service: 'MultiChannelDispatcherService',
        status: 'PROCESSED',
      ...
      if (this.eventBus) {
        await this.eventBus.publish('notification.multichanneldispatcherservice.executed', {
      ...
      this.logger.error('Error executing MultiChannelDispatcherService: ' + err.message, { traceId });
...
module.exports = { MultiChannelDispatcherService };
