/**
 * NOTIFICATION_Enterprise_DomainService_1 - Enterprise Domain Engine
...
class NOTIFICATION_Enterprise_DomainService_1 {
  constructor(repository, eventBus, options = {}) {
    this.serviceName = 'NOTIFICATION_Enterprise_DomainService_1';
    this.domain = 'notification';
    this.repository = repository;
    this.eventBus = eventBus;
    this.options = options;
    this.logger = new Logger('notification-notification_enterprise_domainservice_1');
...
module.exports = { NOTIFICATION_Enterprise_DomainService_1 };
