/**
 * NOTIFICATION_Enterprise_DomainService_20 - Enterprise Domain Engine
...
class NOTIFICATION_Enterprise_DomainService_20 {
  constructor(repository, eventBus, options = {}) {
    this.serviceName = 'NOTIFICATION_Enterprise_DomainService_20';
    this.domain = 'notification';
    this.repository = repository;
    this.eventBus = eventBus;
    this.options = options;
    this.logger = new Logger('notification-notification_enterprise_domainservice_20');
...
module.exports = { NOTIFICATION_Enterprise_DomainService_20 };
