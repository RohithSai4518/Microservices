/**
 * UnsubscribePreference - Domain Model & Invariant Engine
...
class UnsubscribePreference extends AggregateRoot {
  constructor(props = {}) {
  ...
  validateInvariants() {
    if (!this.id) throw new Error('UnsubscribePreference validation error: ID must be populated');
    if (!this.domain) throw new Error('UnsubscribePreference validation error: Domain context required');
    return true;
  }
...
module.exports = { UnsubscribePreference };
