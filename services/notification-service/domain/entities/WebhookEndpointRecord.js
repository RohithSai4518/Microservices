/**
 * WebhookEndpointRecord - Domain Model & Invariant Engine
...
class WebhookEndpointRecord extends AggregateRoot {
  constructor(props = {}) {
  ...
  validateInvariants() {
    if (!this.id) throw new Error('WebhookEndpointRecord validation error: ID must be populated');
    if (!this.domain) throw new Error('WebhookEndpointRecord validation error: Domain context required');
    return true;
  }
...
module.exports = { WebhookEndpointRecord };
