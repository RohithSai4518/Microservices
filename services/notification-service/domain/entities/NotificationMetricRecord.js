/**
 * NotificationMetricRecord - Domain Model & Invariant Engine
...
class NotificationMetricRecord extends AggregateRoot {
  constructor(props = {}) {
  ...
  validateInvariants() {
    if (!this.id) throw new Error('NotificationMetricRecord validation error: ID must be populated');
    if (!this.domain) throw new Error('NotificationMetricRecord validation error: Domain context required');
    return true;
  }
...
module.exports = { NotificationMetricRecord };
