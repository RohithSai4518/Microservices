...
class AUTH_Workflow_StateMachine_9 {
  ...
  transition(targetState, context = {}) {
    if (!this.canTransitionTo(targetState)) {
      throw new Error(`Illegal State Transition: Cannot move from '${this.currentState}' to '${targetState}' in AUTH_Workflow_StateMachine_9`);
    }
...
module.exports = { AUTH_Workflow_StateMachine_9 };
