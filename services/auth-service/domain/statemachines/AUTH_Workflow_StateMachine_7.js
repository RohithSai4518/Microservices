...
class AUTH_Workflow_StateMachine_7 {
  ...
  transition(targetState, context = {}) {
    if (!this.canTransitionTo(targetState)) {
      throw new Error(`Illegal State Transition: Cannot move from '${this.currentState}' to '${targetState}' in AUTH_Workflow_StateMachine_7`);
    }
...
module.exports = { AUTH_Workflow_StateMachine_7 };
