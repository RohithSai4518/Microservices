/**
 * AUTH_Enterprise_DomainService_18 - Enterprise Domain Engine
...
class AUTH_Enterprise_DomainService_18 {
  constructor(repository, eventBus, options = {}) {
    this.serviceName = 'AUTH_Enterprise_DomainService_18';
    this.domain = 'auth';
    this.repository = repository;
    this.eventBus = eventBus;
    this.options = options;
    this.logger = new Logger('auth-auth_enterprise_domainservice_18');
...
module.exports = { AUTH_Enterprise_DomainService_18 };
