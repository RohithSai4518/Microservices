/**
 * AUTH_Enterprise_DomainService_4 - Enterprise Domain Engine
...
class AUTH_Enterprise_DomainService_4 {
  constructor(repository, eventBus, options = {}) {
    this.serviceName = 'AUTH_Enterprise_DomainService_4';
    this.domain = 'auth';
    this.repository = repository;
    this.eventBus = eventBus;
    this.options = options;
    this.logger = new Logger('auth-auth_enterprise_domainservice_4');
...
module.exports = { AUTH_Enterprise_DomainService_4 };
